            ...
            <div className={'bg-white  my-5  '}>
                <div className=''>
                    <ul className={searchState.searchActive ? 'w-full flex gap-4 shadow-md  align-start items-center rounded-xl' : "flex gap-4 shadow-md px-5  items-center rounded-xl"}>
                        <li className={searchState.searchActive ? 'flex flex-col w-[25em] p-2 border-[1px] rounded-xl border-gray-700' : 'flex flex-col'} onClick={()=>{Switcher}}><a href="#" className='cursor-pointer '>
                        ...
                        <li className={searchState.searchActive ? 'flex flex-col w-[25em] p-2' : 'flex flex-col'} onClick={()=>{Switcher('')}}><a href="#" className='cursor-pointer '>
                    ...
                    <div className='flex justify-between  items-start  mx-4 align-middle relative w-[58%]'>
                        <ul className={searchState.searchActive ? 'hidden  mt-10 lg:flex flex-col items-start ' : "hidden"}>
                        ...
                        <div className={searchState.searchActive ? 'mt-10  w-80 lg:flex items-start hidden' : 'hidden'} >
                            <ButtonCounter />
                        </div>
